...
tf.flags.DEFINE_string('mode', "train", "Mode train/ prediction")
#tf.flags.DEFINE_string('mode', "prediction", "Mode train/ prediction")
tf.flags.DEFINE_string("logs_dir", "Logs/", "path to logs directory")
tf.flags.DEFINE_string("tmpl_dir", "TMPLT/", "path to template image(s)")
tf.flags.DEFINE_string("out_dir", "Out/", "path to template image(s)")
